...
* 'configure.py --cpu arm32 --prefix=/home/janusz/czi_proj/cpp_proj_other/Botan2/inst --minimized-build --enable-modules=system_rng,rsa,aes_ni,emsa_pkcs1'
*
* Target
*  - Compiler: /home/janusz/czi_proj/LINARO/gcc-arm-8.3-2019.03-x86_64-arm-linux-gnueabihf/bin/arm-linux-gnueabihf-g++ -fstack-protector -pthread -std=c++11 -D_REENTRANT -O3
*  - Arch: arm32
*  - OS: linux
*/
