...
* 'configure.py --prefix=c:\asrcs\BOTAN\inst --cpu x86_32 --minimized-build --enable-modules=system_rng,rsa,aes,emsa_pkcs1'
*
* Target
...
#define BOTAN_INSTALL_PREFIX R"(c:\asrcs\BOTAN\inst)"
#define BOTAN_INSTALL_HEADER_DIR R"(include/botan-2)"
#define BOTAN_INSTALL_LIB_DIR R"(c:\asrcs\BOTAN\inst\lib)"
