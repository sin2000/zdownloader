...
* 'configure.py --prefix=/Users/ddd/shr/Botan/inst --minimized-build --enable-modules=system_rng,rsa,aes_ni,emsa_pkcs1'
*
* Target
...
#define BOTAN_INSTALL_PREFIX R"(/Users/ddd/shr/Botan/inst)"
#define BOTAN_INSTALL_HEADER_DIR R"(include/botan-2)"
#define BOTAN_INSTALL_LIB_DIR R"(/Users/ddd/shr/Botan/inst/lib)"
